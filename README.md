...
**Bookstore** is a simple react-built app, that allows you to add and delete Books. To add a Book, simply provide tha name of the Book and the Author. once you are done, press the enter key or click submit button to Add the Book.
.
...
git clone https://github.com/musagamfure/bookstore.git
